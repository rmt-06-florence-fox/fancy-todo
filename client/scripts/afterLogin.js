        ...
        response.forEach(todo => {
          ...
          $('#content').append(`
            ...
            <div class="card-header row">
              <button onclick="alterStatus(${id}, '${btn}')" class="col-3 btn-dark m-1 text-light amterial-icons"> ${btn} </button>
              
              <button onclick="showEdit(${id},'${title}', '${description}', '${due_date}')" class="col-3 btn-warning text-dark m-1 material-icons">edit</button>

              <button onclick="deleteTodo(${id})" class="col-3 btn-danger text-light m-1 material-icons">delete_forever</button> 
